...
fn Str8 str8_init(U8 *str, U64 size) { return (Str8){str, size}; }
fn Str8 str8_from_cstr(char *c)      { return (Str8){(U8*)c, cstr8_length((U8*)c)}; }
...
fn Str8 str8_cat(Alloc alloc, Str8 s1, Str8 s2)
{
  Str8 str;
