...
internal Vec4F32
vec_4f32(F32 x, F32 y, F32 z, F32 w)
{
    Vec4F32 v = {x, y, z, w};
    return v;
}
internal Vec4I32
vec_4i32(I32 x, I32 y, I32 z, I32 w)
{
    Vec4I32 v = {x, y, z, w};
    return v;
}
